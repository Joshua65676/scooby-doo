    ...
    <section className="py-[85px] bg-secondary">
      <main className="container max-w-6xl mx-auto w-full">
        <div className="flex flex-col items-center gap-[20px]">
          <h3 data-aos="fade-down" className="xl:text-[59px] md:text-[59px] mx:text-[45px] leading-[39.2px] text-center text-primary font-bold font-cinema uppercase">
            Tokenomics
          </h3>

          <div className="">
            <div className="flex flex-row justify-between gap-[00] relative top-[80px]">
              <div data-aos="fade-down-right" className="flex flex-row xl:pl-14 md:pl-28 mx:pr-8">
              ...
              <div data-aos="fade-down-left" className="flex flex-row-reverse xl:pl-52 md:pl-36 mx:pl-3 top-10 relative">
            ...
            <div data-aos="zoom-in" className="xl:pl-[22rem] md:pl-[16rem] mx:pl-[6rem] md:pt-32 xl:pt-3 mx:pt-36 flex  items-center">
            ...
            <div className="flex flex-row justify-between relative xl:-top-[80px] md:-top-[4px] mx:top-[28px]">
              <div data-aos="fade-up-right" className="flex flex-row xl:-ml-10 mx:ml-">
              ...
              <div data-aos="fade-up-left" className="flex flex-row-reverse relative xl:-top-10 xl:pr-10 md:pr-28 mx:pl-2">
          ...
          <div data-aos="fade-up" className="xl:pt-0 md:pt-10 mx:pt-14">
