...
const RoadMap: React.FC = () => {
  return (
    <section className="py-[85px]">
      <main className="container max-w-6xl mx-auto w-full xl:h-[450px]">
        <div className="flex flex-col items-center xl:gap-[20px] md:gap-[5rem] ">
          <h3  data-aos="fade-down" className="text-[59px] leading-[39.2px] text-center text-primary font-bold font-cinema uppercase">
            RoadMap
          </h3>
