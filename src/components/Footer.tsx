        ...
        <div className="flex flex-col gap-5 text-center items-center">
          ...
          <div className="flex flex-col gap-[13rem]">
            <div className="flex flex-col gap-2">
              <h2 className="text-tertiary font-extrabold uppercase text-[72px]">
                Scooby-doo
              </h2>
              <p className="text-tertiary text-[18px] font-medium leading-[26px]">
                Scooby turns every mystery into an adventure, proving that even
                the most unlikely hero can save the day.
              </p>
            </div>
            <div className="">
                <span className="text-tertiary text-[18px] font-bold leading-[26px]">
